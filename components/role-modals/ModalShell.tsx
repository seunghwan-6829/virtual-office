...
export default function ModalShell({ worker, onClose, children, wide }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm"
      ...
      <div className={`bg-gray-900 border border-gray-700 rounded-2xl shadow-2xl mx-4 overflow-hidden flex flex-col ${wide ? 'w-full max-w-2xl max-h-[85vh]' : 'w-full max-w-md max-h-[85vh]'}`}>
